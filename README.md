...
> All repositories here are portfolio-facing copies.&nbsp;  Their age varies greatly, from today up to about eight years ago.



## Choose a technology

I've worked in a variety of technology mixes, but the two categories here cover the ones in this portfolio.
...
With JobWave, I can transform job listings from other sites, search, sort, and cache them, and copy them to the clipboard with one click.&nbsp;  JobWave keeps everything in the browser's local storage.

> To make use of this tool on short notice, I first wrote JobWave in a procedural style in one JS file, as seen here.&nbsp;  Now I'm refactoring it and putting it under test using [Risei](#risei).&nbsp;  Only the beginnings of that overhaul are seen here.
...
> ### Screenshots
> Here is the UI of JobWave with a job listing transformed at the top.&nbsp;  I can't claim the styling is gorgeous, but it's clear and distinguishes things clearly.
>
...
>
> ... And here is one of the flashes seen when any right-side button is clicked.&nbsp;  The flash fades in a quarter-second.&nbsp;  Colors vary.&nbsp;  In this case, I clicked the down arrow in _Rearranger_.&nbsp;  I can claim this _is_ gorgeous.
>
...
>
> ... And here is the result when the job listing at the top has been found among the cached listings (seen after a flash).&nbsp;  I want all listings to be unique, so the result and flash are yellow, meaning bad news.&nbsp;  Again, this _is_ gorgeous.
>
...
I worked for a while with React, and created some pretty nice components, along with features that used them, but they were proprietary code.&nbsp;  As a result, I don't have a repo of them, or even screenshots.&nbsp;  Personal projects demonstrating my React skills will appear here later.
...
I worked for a little while with Angular, as well as making some personal projects with it.&nbsp;  All of it looked and worked great.&nbsp;  However, those projects were not finished enough to link here.&nbsp;  Personal projects demonstrating my Angular skills will appear here later.
